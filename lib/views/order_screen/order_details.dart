...
import 'package:sellersapp/views/order_screen/components/order_place.dart';
              ...
              child: Column(
                children: [
                  ...
                  Visibility(
                    ...
                    ).box.padding(const EdgeInsets.all(8)).outerShadowMd.white.border(color: lightGrey).roundedSM.margin(const EdgeInsets.only(bottom: 4)).make(),
                  ),
                  ...
                  ).box.outerShadowMd.white.border(color: lightGrey).roundedSM.margin(const EdgeInsets.only(bottom: 4)).make(),
                  const Divider(),
                  10.heightBox,
